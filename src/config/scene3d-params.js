...
const DEFAULT_PRESET = {
  ...
  particleColorHex: '#3874ff',
  starParticleGradient: 'white',
  starParticleColorHex: '#ffea00',
  magnitudeLevel: 1,
  cameraX: 2,
  cameraY: 0.05,
  cameraZ: 14,
  ...
  starRadius: 4.6,
  starParticleSize: 0.01,
  starParticleStartSize: 0,
  starParticleEndSize: 100,
  starParticleNoiseAmount: 0.4,
  starParticleNoiseSpeed: 2.2,
  starParticleLifetimeMin: 0.5,
  starParticleLifetimeMax: 1.5,
