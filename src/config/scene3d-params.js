...
export const FILTER_SCHEMA_VERSION = 3.4;
...
export const PARAM_SCHEMA = {
  ...
  cameraX: { default: 0, min: -360, max: 360, label: 'Camera X' },
  cameraY: { default: -0.5, min: -360, max: 360, label: 'Camera Y' },
  cameraZ: { default: 3, min: 1, max: 360, label: 'Camera Z' },
  ...
  cameraPanX: { default: 0.1, min: -1000, max: 1000, label: 'Scene offset X' },
  cameraPanY: { default: 0, min: -1000, max: 1000, label: 'Scene offset Y' },
  cameraPanZ: { default: 0, min: -1000, max: 1000, label: 'Scene offset Z' },
  targetX: { default: 0, min: -360, max: 360, label: 'LookAt target X' },
  targetY: { default: 0, min: -360, max: 360, label: 'LookAt target Y' },
  targetZ: { default: 0, min: -360, max: 360, label: 'LookAt target Z' },
  ...
  coreTextureUrl: { default: './Ice_002_SD/Ice_002_COLOR.jpg', label: 'Core texture URL (Color)' },
  coreNormalMapUrl: { default: './Ice_002_SD/Ice_002_NORM.jpg', label: 'Normal map URL' },
  coreDispMapUrl: { default: './Ice_002_SD/Ice_002_DISP.png', label: 'Displacement map URL' },
  coreSpecMapUrl: { default: './Ice_002_SD/Ice_002_SPEC.jpg', label: 'Specular map URL' },
  coreOccMapUrl: { default: './Ice_002_SD/Ice_002_OCC.jpg', label: 'AO map URL' },
  ...
  coreBevelSize: { default: 0, min: 0, max: 1000, label: 'Bevel size' },
  coreShadingFlat: { default: 0, min: 0, max: 1, label: 'Shade flat' },
...
const DEFAULT_PRESET = {
  ...
  coreEnabled: 1,
  coreRadius: 4.995,
  coreGlowStrength: 100,
  coreGlowAmbient: 0,
  coreGlowRadial: 1,
  coreBlendMode: 'screen',
  coreSegmentsLat: 128,
  coreSegmentsLon: 128,
  coreTextureUrl: './Ice_002_SD/Ice_002_COLOR.jpg',
  coreNormalMapUrl: './Ice_002_SD/Ice_002_NORM.jpg',
  coreDispMapUrl: './Ice_002_SD/Ice_002_DISP.png',
  coreSpecMapUrl: './Ice_002_SD/Ice_002_SPEC.jpg',
  coreOccMapUrl: './Ice_002_SD/Ice_002_OCC.jpg',
  coreTextureStrength: 1,
  coreNormalStrength: 2,
  coreDispStrength: 0,
  coreSpecStrength: 2,
  coreOccStrength: 1,
  coreBrightnessMin: -0.24,
  coreBrightnessMax: 1.54,
  coreTextureType: 'uv',
  coreZExponent: 1,
  coreBevelSize: 0,
  coreShadingFlat: 0,
  coreRotationSpeed: 11,
  ...
  particleCount: 70000,
  particleSize: 3.21,
  particleStartSize: 0.87,
  particleEndSize: 5.52,
  diskRadius: 100,
  diskThickness: 1.996,
  particleNoiseAmount: 0.15,
  particleNoiseSpeed: 20,
  particleLifetimeMin: 5,
  particleLifetimeMax: 20.5,
  motionMode: 'orbit',
  speedScale: 1,
  maxSpeed: 10.91,
  starParticleCount: 40000,
  starRadius: 5,
  starParticleSize: 9.96,
  starParticleStartSize: 100,
  starParticleEndSize: 0,
  starParticleNoiseAmount: 0.4,
  starParticleNoiseSpeed: 2.2,
  starParticleLifetimeMin: 0.5,
  starParticleLifetimeMax: 1,
  ...
  lightHeight: 17,
  lightDirection: 164,
  fresnelColorHex: '#ffffff',
  fresnelPower: 8,
  fresnelStrength: 0.98,
