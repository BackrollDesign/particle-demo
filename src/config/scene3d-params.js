...
export const PARAM_SCHEMA = {
  ...
  cameraPanX: { default: 0.1, min: -360, max: 360, label: 'Scene offset X' },
  cameraPanY: { default: 0, min: -360, max: 360, label: 'Scene offset Y' },
  cameraPanZ: { default: 0, min: -360, max: 360, label: 'Scene offset Z' },
...
const DEFAULT_PRESET = {
  ...
  coreBrightnessMax: 1.16,
  coreTextureType: 'xyz_normalized',
  coreZExponent: 1,
  coreBevelSize: 0,
  coreShadingFlat: 0,
  coreRotationSpeed: 17,
  ...
  speedScale: 0.8,
  maxSpeed: 3.91,
  starParticleCount: 55000,
  starRadius: 5.5,
  starParticleSize: 0.01,
  starParticleStartSize: 3.49,
  starParticleEndSize: 13.66,
  starParticleNoiseAmount: 0.9,
  starParticleNoiseSpeed: 2.6,
  starParticleLifetimeMin: 0.5,
  starParticleLifetimeMax: 18.5,
