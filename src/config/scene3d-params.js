...
const DEFAULT_PRESET = {
  ...
  particleSize: 2.63,
  particleStartSize: 0,
  particleEndSize: 2.33,
  diskRadius: 100,
  diskThickness: 1.996,
  particleNoiseAmount: 0,
  particleNoiseSpeed: 20,
  particleLifetimeMin: 5,
  particleLifetimeMax: 11,
  motionMode: 'orbit',
  speedScale: 1,
  maxSpeed: 10.91,
  starParticleCount: 50000,
  starRadius: 5,
  starParticleSize: 3.16,
  starParticleStartSize: 0,
  starParticleEndSize: 0,
  starParticleNoiseAmount: 0.05,
  starParticleNoiseSpeed: 0.3,
  starParticleLifetimeMin: 3.5,
  starParticleLifetimeMax: 8,
