...
export const PARAM_SCHEMA = {
  ...
  coreZExponent: { default: 1, min: 0.2, max: 3, label: 'Z exponent 3D shape' },
  ...
  fresnelColorHex: { default: '#FFFFFF', label: 'Fresnel color' },
...
const DEFAULT_PRESET = {
  ...
  starParticleStartSize: 15.13,
  starParticleEndSize: 0,
  starParticleNoiseAmount: 0.001,
  starParticleNoiseSpeed: 2.8,
